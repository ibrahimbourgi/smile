...
import 'package:smile/controller/auth/success_reset_email_controller.dart';
...
class SuccesResetPassword extends StatelessWidget {
  const SuccesResetPassword({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    SuccessResetEmailControllerImp controller =
        Get.put(SuccessResetEmailControllerImp());
    return Scaffold(
